...
import { newResponseController, deleteResponseController, getAllResponsesController, updateResponseController } from '../controllers/responses/index.js';
...
// Crear una respuesta
responsesRouter.post('/responses', newResponseController);
...
responsesRouter.put('/responses/:response_id', responseExistsController, updateResponseController);
