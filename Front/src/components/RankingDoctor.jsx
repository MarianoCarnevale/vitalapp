...
export const RankingDoctor = () => {
  ...
  return (
    <section className="max-lg:max-w-lg lg:w-full m-auto flex flex-col gap-6 items-center">
      ...
      <ul className="w-full max-lg:h-full max-h-[22.5rem] flex flex-col gap-3 dark:bg-gradient-to-t dark:from-slate-900 dark:to-sky-800  bg-white p-5 border-white rounded-3xl h-full max-h overflow-auto hide-scrollbar shadow-lg">
        {doctors.map((doctor) => {
          return (
