  ...
  return (
    <section className="w-full m-auto   gap-6 items-center">
      ...
      <div className="  gap-2 items-left  w-full  border-primary rounded-3xl">
        <ul className="w-full max-lg:h-full flex h-[22rem] flex-col gap-5 dark:bg-gradient-to-t dark:from-slate-900 dark:to-sky-800   bg-white p-5 lg:my-5  border-white rounded-3xl overflow-auto hide-scrollbar shadow-lg">
          {results.filter(
