  ...
  return (
    <>
      <div className="  gap-2 items-left h-fit w-full  border-primary rounded-3xl">
        <p className="max-lg:mb-10 mb-5 w-5/6 text-left  text-primary dark:text-white font-semibold text-3xl ">
          Consultas Pendientes
        </p>
        <ul className="w-full max-h-[22rem] flex flex-col gap-5 dark:bg-gradient-to-t dark:from-slate-900 dark:to-sky-800   bg-white p-5 border-white rounded-3xl h-full max-h overflow-auto hide-scrollbar shadow-lg">
