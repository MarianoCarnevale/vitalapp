    ...
    <>
      {user.role === "doctor" && (
        <div className="  gap-2 items-left  w-full  border-primary rounded-3xl">
          ...
          <ul className="w-full max-lg:h-full flex flex-col h-[22.5rem] gap-5 dark:bg-gradient-to-t dark:from-slate-900 dark:to-sky-800   bg-white p-5   border-white rounded-3xl overflow-auto hide-scrollbar shadow-lg">
